    ...
    <div className="card p-5 sm:p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-sm text-[var(--dark)] text-tracked">
        ...
        {!loading && (
          <a
            ...
            className="text-xs font-semibold hover:underline text-[var(--primary)]"
          >
            @{username}
          </a>
        )}
      ...
      {/* Total */}
      {!loading && (
        <p className="text-xs mb-3 text-[var(--body-color)]">
          <span className="font-bold text-[var(--dark)]">{total.toLocaleString()}</span>
